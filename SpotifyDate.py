...
#Hours
now = datetime.now()
test = (now.hour, now.minute)
x = [int(a) for a in str(test[0])]
x1 = [int(a) for a in str(test[1])]
...
for i in range(1):
    if hours[0] == 0:
        canvas_firstletter.create_image(200, 200, image=number0)
    elif hours[0] == 1:
        canvas_firstletter.create_image(200, 200, image=number1)
    elif hours[0] == 2:
        canvas_firstletter.create_image(200, 200, image=number2)
    elif hours[0] == 3:
        canvas_firstletter.create_image(200, 200, image=number3)
    elif hours[0] == 4:
        canvas_firstletter.create_image(200, 200, image=number4)
    elif hours[0] == 5:
        canvas_firstletter.create_image(200, 200, image=number5)
    elif hours[0] == 6:
        canvas_firstletter.create_image(200, 200, image=number6)
    elif hours[0] == 7:
        canvas_firstletter.create_image(200, 200, image=number7)
    elif hours[0] == 8:
        canvas_firstletter.create_image(200, 200, image=number8)
    elif hours[0] == 9:
        canvas_firstletter.create_image(200, 200, image=number9)
...
def clock():
    ...
    for _ in hours:
        canvas_firstletter.create_image(200, 200, image=void)
        if hours[0] == 0:
            canvas_firstletter.create_image(200, 200, image=number0)
        elif hours[0] == 1:
            canvas_firstletter.create_image(200, 200, image=number1)
    ...
    for i in hours:
        canvas_firstletter.create_image(700, 200, image=void)
